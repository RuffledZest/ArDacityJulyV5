    ...
    <>
      ...
      >
        <div className="liquidGlass-wrapper relative flex font-semibold overflow-hidden text-black cursor-pointer shadow-[0_6px_6px_rgba(0,0,0,0.2),0_0_20px_rgba(0,0,0,0.1)] transition-all duration-[400ms] ease-[cubic-bezier(0.175,0.885,0.32,2.2)] rounded-2xl p-3 hover:p-4 hover:scale-[1.02] hover:shadow-[0_12px_12px_rgba(0,0,0,0.3),0_0_40px_rgba(0,0,0,0.2)]">
          ...
          {/* Content Layer */}
          <nav className="liquidGlass-text z-[3] relative flex items-center gap-2 rounded-xl p-3  backdrop-blur-sm">
              ...
              return (
                <button
                  ...
                  className={cn(
                    ...
                    "hover:bg-black/5",
                    isActive && "bg-gradient-to-r from-cyan-500/20 to-cyan-500/20",
                  )}
                ...
                >
                  ...
                  {isActive && (
                    <div className="absolute -bottom-1 left-1/2 transform -translate-x-1/2 w-1 h-1 bg-gradient-to-r from-blue-500 to-cyan-500 rounded-full" />
                  )}
                </button>
              )
            })}
